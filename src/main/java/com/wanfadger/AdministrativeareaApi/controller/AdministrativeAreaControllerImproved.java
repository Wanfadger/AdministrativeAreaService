...
public class AdministrativeAreaControllerImproved {
        ...
        @Operation(summary = "Create a single administrative area", description = "Creates a new administrative area. Requires 'type' query parameter to specify the administrative area type. "
                        +
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Administrative area created successfully", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ResponseDTO.class))),
        ...
        public ResponseEntity<ResponseDTO<String>> newOne(
                        @Parameter(description = "Query parameters: 'type' (required: REGION|SUB REGION|LOCAL GOVERNMENT|COUNTY|SUB COUNTY|PARISH)", required = true, examples = {
        ...
        @Operation(summary = "Create multiple administrative areas", description = "Creates multiple administrative areas in a single request. Requires 'type' query parameter. "
                        +
                        "Valid types: REGION, SUB REGION, LOCAL GOVERNMENT, COUNTY, SUB COUNTY, PARISH. " +
                        "Example query: ?type=REGION or ?type=COUNTY&partOf=LG001. " +
                        "Cache is automatically evicted after creation.")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Administrative areas created successfully", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ResponseDTO.class))),
                        @ApiResponse(responseCode = "400", description = "Invalid input data"),
                        @ApiResponse(responseCode = "500", description = "Internal server error")
        })
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Upload completed successfully", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ResponseDTO.class))),
        ...
        @Operation(summary = "Update an administrative area", description = "Updates an existing administrative area. Requires 'type' query parameter and 'code' in the request body. "
                        +
                        "Valid types: REGION, SUB REGION, LOCAL GOVERNMENT, COUNTY, SUB COUNTY, PARISH. " +
                        "Example query: ?type=REGION. " +
                        "Cache is automatically evicted after update.")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Administrative area updated successfully", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ResponseDTO.class))),
        ...
        @Operation(summary = "Get a single administrative area (code and name only)", description = "Retrieves a single administrative area by type and code. Returns only code and name. Results are cached for 7 days. "
                        +
        ...
        @Operation(summary = "Get a list of administrative areas (code and name only)", description = "Retrieves a list of administrative areas by type. Returns only code and name. Results are cached for 7 days. "
                        +
        ...
        @Operation(summary = "Get parishes by parent administrative area", description = "Retrieves all parishes that belong to a parent administrative area (Region, Sub-Region, Local Government, County, or Sub-County). "
                        +
        ...
        public ResponseDTO<List<CodeNameDTO>> getParishByPartOf(
                        @Parameter(description = "Query parameters: 'type' (required - parent type: REGION|SUB REGION|LOCAL GOVERNMENT|COUNTY|SUB COUNTY), 'partOfCode' (required - parent code)", required = true, examples = {
        ...
        @Operation(summary = "Search administrative areas (full details)", description = "Retrieves a list of administrative areas with full details (code, name, latitude, longitude). Results are cached for 1 hour. "
                        +
                        "Query parameters: 'type' (required), optionally 'partOf' for filtering by parent area. " +
                        "Valid types: REGION, SUB REGION, LOCAL GOVERNMENT, COUNTY, SUB COUNTY, PARISH. " +
        ...
        @Operation(summary = "Search a single administrative area (full details)", description = "Retrieves a single administrative area with full details (code, name, latitude, longitude). Results are cached for 1 hour. "
                        +
                        "Query parameters: 'type' (required), 'code' (required), optionally 'partOf' for hierarchical queries. "
                        +
                        "Valid types: REGION, SUB REGION, LOCAL GOVERNMENT, COUNTY, SUB COUNTY, PARISH. " +
