...
public interface CountyService {
    ...
    AdministrativeAreaResponseDto<List<CountyDTO>> list(String localGovernmentCode);

    AdministrativeAreaResponseDto<CountyDTO> getByCode(String code);
    ...
    AdministrativeAreaResponseDto<List<CountyDTO>> search(String name, String code);
